...
<body>
    ...
    <div class="container my-4">
        <div class="alert alert-success" role="alert">
            <h4 class="alert-heading">Welcom - <?php echo $_SESSION['username'] ?></h4>
            <p>hey how are you doing? Welcom to KrishnaPG. You are logged in as <?php echo $_SESSION['username'] ?>. 
